        ...
        if (empty($_FILES["file"]["name"])) {
            ...
            if($check !== false) {
                ...
                if (!in_array($file_extension, $allowed_ext)) {
                    echo "Invalid file type. Please upload JPG, JPEG, PNG or GIF files only.";
                    echo "<a href='index.php'>Back to home</a>";
                    $uploadOk = 0;
                    exit();
                }
                ...
                if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
                    ...
                    $stmt->execute();
                    echo "Uploaded successfully. File Type: " . $check["mime"] . ".";
                    echo "<a href='index.php'>Back to home</a>";
                    echo "<a href='edit.php?file=" . urlencode($target_file) . "&image_name=" . urlencode($image_name) . "&user_id=" . urlencode($user_id) . "&upload-mode=" . urlencode($is_public) . "'>Go to edit the photo.</a>";
                    $uploadOk = 1;
                } else {
                ...
                echo "Invalid file type. File Type: " . $check["mime"] . ".";
                echo "<a href='index.php'>Back to home</a>";
                $uploadOk = 0;
            }
        }
